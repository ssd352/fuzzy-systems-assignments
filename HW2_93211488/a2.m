...
calc_draw3(dedarr(1:2), mfarr(1:4), uod_mf_name(1:4), uod_p , uod_q , uod_pm , uod_qm);
calc_draw3(dedarr(1:2), mfarr(1:4), ss_mf_name(1:4), ss_p , ss_q , ss_pm , ss_qm);
...
function calc_draw3(dedarr, mfarr, mf_name, p , q , pm , qm)
     for cnt1 = 1:length(mfarr)
            %for cnt2 = 1:length(mfarr)
